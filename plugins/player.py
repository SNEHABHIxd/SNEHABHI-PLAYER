...
from abhishek import converter
from abhishek.youtube import youtube
from abhishek.config import DURATION_LIMIT, que, SUDO_USERS
from abhishek.cache.admins import admins as a
from abhishek.snehabhi.filters import command, other_filters
from abhishek.snehabhi.command import commandpro
from abhishek.snehabhi.decorators import errors, authorized_users_only
from abhishek.snehabhi.errors import DurationLimitError
from abhishek.snehabhi.gets import get_url, get_file_name
from abhishek.snehabhi.channelmusic import get_chat_id
import aiofiles
import ffmpeg
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 670),
        f"Powered By: Snehabhi Player (@SNEHABHI_KING)",
        (255, 255, 255),
        font=font,
    )
    img.save("final.png")
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/5c1bd95f066aad81df745.png"
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/5c1bd95f066aad81df745.png", 
                             caption="**💥🔈 Mʋsɩƈ🤞Nøω 🥀\n▶️ Ƥɑʋsɘɗ 🌷 ...**"
    )
